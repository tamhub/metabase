...
First download the [Elastic Beanstalk Community Edition deployment file](https://downloads.metabase.com/{{ site.latest_version }}/metabase-aws-eb.zip) or the [Elastic Beanstalk Enterprise deployment file](https://downloads.metabase.com/enterprise/{{ site.latest_version }}/metabase-aws-eb.zip) to upload to Elastic Beanstalk.
...
- Download the latest Metabase Elastic Beanstalk deployment file:
  - Community Edition[https://downloads.metabase.com/{{ site.latest_version }}/metabase-aws-eb.zip](https://downloads.metabase.com/{{ site.latest_version }}/metabase-aws-eb.zip)
  - Enterprise Edition: [https://downloads.metabase.com/enterprise/{{ site.latest_version }}/metabase-aws-eb.zip](https://downloads.metabase.com/enterprise/{{ site.latest_version }}/metabase-aws-eb.zip)
